...
/// OrganizationUser : HyperlinkedModelSerializer with `id` as the first field.
...
impl OrganizationUser {
    ...
    pub fn new(id: String, url: String, organization: String, created: String, modified: String, user: String) -> OrganizationUser {
        OrganizationUser {
            id,
            url,
            organization,
