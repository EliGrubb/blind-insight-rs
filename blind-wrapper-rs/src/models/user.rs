...
/// User : HyperlinkedModelSerializer with `id` as the first field.
...
impl User {
    ...
    pub fn new(id: String, url: String, has_identity: bool, email: String) -> User {
        User {
            id,
            url,
            has_identity,
